# comprehension-exercise-generation

## Purpose

Asynchrone AI-generatie van begrijpend-leesoefeningen: een queued job roept een Anthropic Opus-agent met didactische system prompt aan, dwingt structured output af, valideert de kwaliteit programmatisch en slaat het resultaat op.
