# crossword-solution-word

## Purpose

Het puzzelwoord van een kruiswoordpuzzel: een woord dat het kind uit het opgeloste rooster moet halen. Het wordt zonder AI-aanroep gekozen uit de kandidaten die niet in het rooster geplaatst zijn, krijgt per letter een eigen vakje in het gelegde rooster, en wordt gespreid over verschillende ingangen zodat het kind meerdere woorden moet oplossen. Deze capability beschrijft de keuze, de toewijzing van vakjes, de markering in het rooster en de opslag.
