...
enum LevelBand: string implements HasLabel
{
    ...
    {
        return match (true) {
            $level >= 1 && $level <= 10 => self::Band1To10,
    ...
    {
        return __("common.level_band.{$this->value}");
    }

    public function getDescription(): string
    {
        return __("common.level_band_descriptions.{$this->value}");
    }
}
